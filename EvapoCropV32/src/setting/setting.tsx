...
> {
    ...
    getDefaultMetricFields = (fieldNames: string[]): string[] => {
        // For crop distribution, we're interested in area fields
        const commonMetricFields = fieldNames.filter(f =>
            ['area_ha', 'area', 'ekin_turi', 'crop_area', 'percentage'].includes(f.toLowerCase())
        );
            ...
            <div className="widget-setting-container">
                ...
                <div className="setting-section">
                    ...
                    <MapWidgetSelector
                        ...
                        isNeedConfirmBeforeChange={true}
                        confirmMessage="Switching the connected Map widget will clear any active filters and data. Do you want to continue?"
                    />
                </div>
                ...
                <div className="setting-section">
                    ...
                    <div className="setting-row">
                        <Label check>
                            ...
                            />
                            Enable crop distribution chart visualization
                        </Label>
                    </div>
                    <p className="setting-note">
                        When enabled, a pie chart will be displayed showing the distribution of crop types by area.
                    </p>
                </div>
                ...
                {this.props.useDataSources && this.props.useDataSources.length > 0 && (
                    <div className="setting-section">
                        <h3 className="setting-label">Select Crop Fields:</h3>
                        <p className="setting-note">
                            These fields will be used for categorizing and measuring crops in the chart.
                        </p>
                        <FieldSelector
                            useDataSources={this.props.useDataSources}
